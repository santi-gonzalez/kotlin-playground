...
@AppScope @Component(
    modules = arrayOf(ApplicationModule::class, DataSourceModule::class, RepositoryModule::class, RestModule::class,
                      UseCaseModule::class)) interface AppComponent : RepositoryProvider, UseCaseProvider {
  fun inject(app: App)
}
